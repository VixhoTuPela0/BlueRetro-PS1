...
#define MACRO_BASE (BIT_32(BR_COMBO_BASE_1) | BIT_32(BR_COMBO_BASE_2) | BIT_32(BR_COMBO_BASE_3))
#define SYS_RESET (MACRO_BASE | BIT_32(BR_COMBO_SYS_RESET))
#define BT_INQUIRY (MACRO_BASE | BIT_32(BR_COMBO_BT_INQUIRY))
#define SYS_POWER_OFF (MACRO_BASE | BIT_32(BR_COMBO_SYS_POWER_OFF))
#define FACTORY_RESET (MACRO_BASE | BIT_32(BR_COMBO_BASE_4) | BIT_32(BR_COMBO_FACTORY_RESET))
#define DEEP_SLEEP (MACRO_BASE | BIT_32(BR_COMBO_BASE_4) | BIT_32(BR_COMBO_DEEP_SLEEP))
#define WIRED_RST (MACRO_BASE | BIT_32(BR_COMBO_WIRED_RST))
